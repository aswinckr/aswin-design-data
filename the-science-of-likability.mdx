...
In another book on improv comedy techniques, I learned that to make a scene watchable, it needs to have three elements: People, Experiences, and Situations. Despite this, when talking to a stranger, most of us tend to stick to neutral topics in an effort to get to know them, like where are they from, what do they do etc.
